                ...
                <div className='logged-in'>
                    <div className={addressName}>DELIVERY ADDRESS</div>
                     {user[userId.id].address.map((data,index)=>(
                        ...
                        <div className='deliverButton'><button onClick={(e)=>{btnHanler()}}>Deliver Here</button></div>
                     
                </div>}
                <div>
                    <div className={displayField} onClick={(e)=>{setDisplayField('display')
                    setAddressname('diliveryAddress')}}>+Add New Address</div>
                    ...
                    <div className='logged-in'>
                        <form onSubmit={onSubmitHandler} className='new-address'>
                            ...
                            <div className='deliverButton'><button type='submit'>Save</button></div>
                        </form>
                    </div>}
                </div>
            </div>
